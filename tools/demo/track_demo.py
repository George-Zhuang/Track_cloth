...
def make_parser():
    ...
    # input data
    parser.add_argument('--data_dir', type=str, default='./data/demo/images', help='file names') 
    parser.add_argument('--seq', type=str, default='demo', help='all or None ==> all the seqs') 
    parser.add_argument('--det_preds', type=str, default='./data/demo/det_res/', help='detection results')
    ...
    # output data
    parser.add_argument('--output_path', type=str, default='./data/demo/track_res', help='output path')
